...
export default function Index() {
  return (
    <>
    <BlockDisplay>Heiaaa! I am Astrid, a designer and developer from Northern Norway <BlockIcon>🏔️</BlockIcon>. I have always been passionate about design and technology, but after working with graphic design, websites and coding for 6 years, I felt the need to do something else. Currently I am doing a master’s degree in design at <a href="https://aho.no" target="_blank" rel="external">The Oslo School of Architecture and Design</a>, and I want to help design digital products and services that matter, improving the future for both people and planet <BlockIcon>🌍</BlockIcon>.</BlockDisplay>
    
    <h2>This is some of my projects 👇</h2>
    <BlockProjects />
    ...
    {experience.slice(0, 3).map((experience) => (
      ...
      <p className={utils.small}>Last updated in February 2024. Inspired by <a href="https://nownownow.com/about" target="_blank" rel="external">Now</a>.</p>
