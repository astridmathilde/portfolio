...
export default function Colophon() {
  return (
    ...
    <p>I have not used generative AI for the content on this website. Not only because I prefer to use my own brain and creativity, but also because the Large Language Models (LLMs) are associated with high energy consumption. Even though some LLMs are more or less running on renewable energy, they still require a lot of resources, which I do not believe is worth it when it comes to dealing with everyday problems. For instance, one single prompt in ChatGPT might require up to 15 times more energy than a Google search*.</p>
