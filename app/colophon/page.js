...
export default function Colophon() {
  return (
    ...
    <p>You can <a href="https://github.com/astridmathilde/astridmathilde/" target="_blank" rel="nofollow noreferrer">view the code on Github</a>, <Link href="/resumee">read my resumee</Link>, or look at <Link href="/projects/bams">one of my projects.</Link></p>
    </>
    )
  }